...
<!-- navbar container -->
<header class="navbar bg-base-200 mb-10"> 

	<div class="navbar-start">
		<a href="/" class="hover:text-primary pl-10" aria-label="Home">	
	...
	<div class="navbar-center">
		<ul class="menu menu-horizontal px-1 font-bold text-2xl space-x-3">
			...
			<li><a href="/table" class="hover:bg-primary">Table</a></li>
...
<footer class="footer bg-base-300 text-base-content p-10 mt-10">
	<nav>
